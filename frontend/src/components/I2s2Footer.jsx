  ...
  return (
    <div className="w-full px-10 md:px-20 py-1 bg-[#f7fcfc] ">
      <div className="flex pb-10">
        ...
        <div className="w-2/3 h-auto grid grid-cols-4 gap-5 ">
          <div>
            {/* <h4>Useful Links</h4>
            <p>Home</p>
            <p>About us</p>
      ...
      <div className="w-full flex flex-col items-center justify-center p-2  border-gray-200 border-t-2">
        <p>
          © Copyright {currYear} <strong>Medicio</strong> All Rights Reserved
        </p>
